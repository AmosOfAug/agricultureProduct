		        ...
		        <div class="row" style="margin-top: -20px; margin-left: -25px;margin-right: -25px;">
		            <div class="col-md-12">
		                <ul class="breadcrumb" style="background-color: #FFFFFF">
		                    ...
		                    <li style="float:right"><span class="span">用户总数：${pagination.totalCount}</span></li>
		                </ul>
		            </div>
		        </div>
		        <div class="row">
		           <table class="table" style="margin-top: -24px;">
				      ...
				      <tbody>
				        <c:forEach items="${allUser}" var="n">
			                    <tr class="active">
						          <th scope="row">${n.userId }</th>
						          <td><a href="<%=PathUtil.getFullPath("user/user-information/")%>${n.userId }">${n.userName}</a></td>
						          <td>${n.phone }</td>
						          <td>${n.role==1?'普通用户':'商家' }</td>
						          <td>${n.createTime}</td>
						          <td>${n.updateTime}</td>
						          <td><a href="<%=PathUtil.getFullPath("user/delete-user")%>/${n.userId }"><i class="glyphicon glyphicon-remove" style="margin-left: 20px;"></i></a></td>
						        </tr>
			            </c:forEach>
			    ...
			    <div class="row" style="margin-top: -24px;">
			        ...
			        <div class="col-md-4">
				        <ul class="pagination pagination-lg">
							<li><a href="<%=PathUtil.getFullPath("user/all-users")%>/${pagination.currentPage>1?pagination.currentPage-1:1}"><i class="fa glyphicon glyphicon-menu-left"></i></a></li>
